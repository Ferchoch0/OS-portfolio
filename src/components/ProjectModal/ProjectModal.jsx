                        ...
                        {hasImages ? (
                            <div className={styles.galleryWrapper}>
                                <div className={styles.mainImageWrapper} onClick={() => setLightboxOpen(true)}>
                                    ...
                                    <img src={images[currentImageIndex]} alt={project.title} className={styles.mainImage} />
                            ...
                            <div className={styles.actions}>
                                ...
                                <div className={styles.ctaRow}>
                                    ...
                                    {isLive && (
                                        ...
                                        >
                                            <span className={styles.liveBtnText}>Ver Demo</span>
                                    ...
                                    {!isLive && (
                                        ...
                                        >
                                            <span className={styles.liveBtnText}>Solicitar Demo</span>
                                            <span className={styles.btnArrow}>
